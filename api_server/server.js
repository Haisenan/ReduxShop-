...
//
let conn=mysql.createConnection({host: 'localhost', user: 'root', password: '', database: 'haisenshop'});
let db=wrapper(conn);
...
router.get('/list', async ctx=>{
  let rows=await ctx.db.query("SELECT * FROM item_table order by Id asc");
